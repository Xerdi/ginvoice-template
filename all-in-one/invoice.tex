...
\hasparam{supplier}{%
    \loadpayload[supplier]{suppliers/\rawparam{\jobname}{supplier}.yaml}
}{}

\hasparam[supplier]{style}{%
    \loadpayload[style]{styles/\rawparam{supplier}{style}.yaml}
...
\begin{tabular}{@{}l@{}}
    ...
    \end{tabular} \\
    \begin{tabular}{@{}l l@{}}
        Invoice number: & \param{number}\\
        Invoice date: & \param{date}\\
    \end{tabular}
\end{tabular}
\hfill
\begin{tabular}{@{}l r@{}}
    Company: & \param[supplier]{name} \\
    Email: & \param[supplier]{email} \\
    Website: & \param[supplier]{website} \\
    Account nr: & \param[supplier]{account number} \\
...
% Header
{\textbf{Description} & \textbf{Date} & \textbf{Quantity} & \textbf{Price} & \textbf{Total} \\ \hline}
% Totals
{%
    & & & \textbf{Total (ex.)} & \currency\hfill{\ttfamily\paramfield{totals}{total ex}} \\
    & & & \textbf{VAT} & \currency\hfill{\ttfamily\paramfield{totals}{vat}} \\
    & & & \textbf{Total (incl.)} & \currency\hfill{\ttfamily\paramfield{totals}{total incl}} \\
}
